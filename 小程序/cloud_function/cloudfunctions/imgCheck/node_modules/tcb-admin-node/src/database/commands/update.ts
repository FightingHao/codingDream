...
import { assertRequiredParam } from 'utils/assert'
...
export class UpdateCommand implements DB.DatabaseUpdateCommand {
  ...
  _setFieldName(fieldName: string): DB.DatabaseUpdateCommand {
