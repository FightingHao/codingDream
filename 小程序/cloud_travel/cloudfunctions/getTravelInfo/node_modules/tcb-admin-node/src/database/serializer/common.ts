import { isQueryCommand } from '../../../../api/database/commands/query'
import { isLogicCommand } from '../../../../api/database/commands/logic'
import { isUpdateCommand } from '../../../../api/database/commands/update'
...
import { Point } from '../../../../api/database/geo/point'
...
export function encodeInternalDataType(val: any): DB.IQueryCondition {
